...
public class MissonBoardDB extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("create table missionBoard(mainno integer primary key," +
                ...
                " missonStartDay date, missonEndDay date, joinCoin Long ," +
                " missonLeader, missonState)");
    }
    //업그레이드 될 때 호출되는 메서드
